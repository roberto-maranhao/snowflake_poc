...
-- Grant privileges to drop and recreate roles if needed
GRANT DROP ON ALL ROLES IN ACCOUNT TO ROLE TERRAFORM_DEV_ROLE;
GRANT DROP ON ALL ROLES IN ACCOUNT TO ROLE TERRAFORM_PROD_ROLE;

-- Grant ability to assign roles to users
GRANT GRANT ROLE ON ALL ROLES IN ACCOUNT TO ROLE TERRAFORM_DEV_ROLE;
GRANT GRANT ROLE ON ALL ROLES IN ACCOUNT TO ROLE TERRAFORM_PROD_ROLE;
